/* ===========================================================================
   js/apply.js
   ---------------------------------------------------------------------------
   Analyst application form: client-side validation, division-choice
   ...
   SETUP: set data-endpoint on the form to the deployed Apps Script URL
...
(function () {
  ...
  if (!form) return;
  // Endpoint lives on the form (data-endpoint). Empty means the analyst Apps
  // Script is not deployed yet: the form refuses to submit rather than silently
  ...
  /* --- Division choice: name the chosen division in the optional "why" question --- */
  var whyLabel = form.querySelector("[data-why-label]");
  function syncChoices() {
    whyLabel.textContent = choice1.value
      ? "Why have you selected " + choice1.value + " as your first division?"
  ...
  // Initialise the optional question label on load.
  syncChoices();
})();
